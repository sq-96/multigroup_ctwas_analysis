...
results_dir <- "/project/xinhe/shengqian/cTWAS_simulation/simulation_two_tissues_expression/"
runtag = "two_tissues"
...
### Prior Variance
```{r,echo=FALSE,fig.width= 10, fig.height= 5}
true_value_gene1 <- 15.43103
true_value_gene2 <- 15.43103
true_value_SNP <- 10.81125
plot_prior_variance(results_dir,runtag,thins,group_prior_var_structures,null_methods,file_name,true_value_gene1,true_value_gene2,true_value_SNP)
```
...
### Prior Variance
```{r,echo=FALSE,fig.width= 10, fig.height= 5}
true_value_gene1 <- 18.0348
true_value_gene2 <- 18.0348
true_value_SNP <- 10.81125
plot_prior_variance(results_dir,runtag,thins,group_prior_var_structures,null_methods,file_name,true_value_gene1,true_value_gene2,true_value_SNP)
```
...
### Prior Variance
```{r,echo=FALSE,fig.width= 10, fig.height= 5}
true_value_gene1 <- 20.84147
true_value_gene2 <- 20.84147
true_value_SNP <- 10.81125
plot_prior_variance(results_dir,runtag,thins,group_prior_var_structures,null_methods,file_name,true_value_gene1,true_value_gene2,true_value_SNP)
```

## Enrichment=1 (prior_gene = 0.0025, adipose=0, sigma_gene = 0.0155)
gene prior = 2.5e-3, snp prior = 2.5e-3, sigma_gene = 0.0155, sigma_snp = 0.0155, 7395 genes and 500000 SNPs
```{r,echo=FALSE,fig.width= 8, fig.height= 4}
results_dir <- "/project/xinhe/shengqian/cTWAS_simulation/simulation_two_tissues_expression/"
runtag = "two_tissues"
...
## Enrichment=1 (prior_gene = 0.0025, adipose=0, sigma_gene = 0.0185)
gene prior = 2.5e-3, snp prior = 2.5e-3, sigma_gene = 0.0185, sigma_snp = 0.0155, 7395 genes and 500000 SNPs
```{r,echo=FALSE,fig.width= 8, fig.height= 4}
results_dir <- "/project/xinhe/shengqian/cTWAS_simulation/simulation_two_tissues_expression/"
runtag = "two_tissues"
...
## Enrichment=1 (prior_gene = 0.0025, adipose=0, sigma_gene = 0.0200)
gene prior = 2.5e-3, snp prior = 2.5e-3, sigma_gene = 0.0200, sigma_snp = 0.0155, 7395 genes and 500000 SNPs
```{r,echo=FALSE,fig.width= 8, fig.height= 4}
results_dir <- "/project/xinhe/shengqian/cTWAS_simulation/simulation_two_tissues_expression/"
runtag = "two_tissues"
...
## Enrichment=1 (prior_gene = 0.0025, adipose=0,sigma_gene = 0.0215)
gene prior = 2.5e-3, snp prior = 2.5e-3, sigma_gene = 0.0215, sigma_snp = 0.0155, 7395 genes and 500000 SNPs
```{r,echo=FALSE,fig.width= 8, fig.height= 4}
results_dir <- "/project/xinhe/shengqian/cTWAS_simulation/simulation_two_tissues_expression/"
runtag = "two_tissues"
