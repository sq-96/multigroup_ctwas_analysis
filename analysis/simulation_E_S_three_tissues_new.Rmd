...
truth <- rbind(c(1,0.009),c(2,0.009),c(3,0),c(4,0),c(3,0),c(4,0))
est <- rbind(cbind(1,y1),cbind(2,y2),cbind(3,y4),cbind(4,y4),cbind(3,y4),cbind(4,y4))
...
truth <- rbind(c(1,0.03),c(2,0.03),c(3,0),c(4,0),c(3,0),c(4,0))
est <- rbind(cbind(1,y1),cbind(2,y2),cbind(3,y4),cbind(4,y4),cbind(3,y4),cbind(4,y4))
...
truth <- rbind(c(1,36),c(2,36),c(3,0),c(4,0),c(3,0),c(4,0))
est <- rbind(cbind(1,y1),cbind(2,y2),cbind(3,y4),cbind(4,y4),cbind(3,y4),cbind(4,y4))
