...
load("/project2/xinhe/shengqian/cTWAS/cTWAS_analysis/data/mashr_sqtl/sqtl/mashr/intron_mapping_info.RData")
#intron_info <- intron_info[intron_info$gene_type=="protein_coding",]
...
```{r, fig.width= 8, fig.height= 4, echo=FALSE, warning=FALSE}
f1 <- plot_PIP(results_dir, runtag, simutags, "UKBBLD", main = "molecular traits PIPs")
f2 <- plot_PIP_combined(results_dir, runtag, simutags, "UKBBLD", main = "Gene level PIPs")
gridExtra::grid.arrange(f1, f2, ncol=2)
```
