...
### PIP attribution among tissues by eQTL (UKBBLD)
```{r, echo=FALSE, fig.width= 8, fig.height= 4, warning=FALSE}
par(mfrow = c(1, 2))
pip_partition_across_tissue_by_QTLtype(results_dir, runtag, simutags, "UKBBLD", PIP_threshold = 0.8, "eQTL","Expression")
pip_partition_across_tissue_by_QTLtype(results_dir, runtag, simutags, "UKBBLD", PIP_threshold = 0.8, "sQTL","Splicing")
```
