...
plot_PIP_csindex <- function(configtag, runtag,  simutags, ...){
   ...
   susieIfs <- paste0(results_dir, runtag, "_simu",simutags, "_GTEXLD.finemap_regions.res.RDS")
...
f1 <- plot_PIP_csindex(results_dir, runtag, simutags, main = "no merged regions")
f2 <- plot_PIP_combined_csindex(results_dir, runtag, simutags, main = "no merged regions")
```
