...
```{r}
ctwas_res <- data.table::fread(paste0(results_dir, runtag, "_simu", simutags[5], "_config", configtag, "_LDR.susieIrss.txt"))
ctwas_gene_res <- ctwas_res[ctwas_res$type!="SNP",]
ctwas_gene_res[ctwas_gene_res$susie_pip>0.7 & ctwas_gene_res$susie_pip<0.8]
```
