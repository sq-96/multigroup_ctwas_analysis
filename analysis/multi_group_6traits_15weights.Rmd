...
### Comparing with eQTL results (the tissue with the largest number of sig genes)

```{r echo=FALSE}
tissue <- "Cells_Cultured_fibroblasts"
sprintf("the top tissue is %s",tissue)
...
sig_gene_single <- finemap_res_single[finemap_res_single$type !="SNP" & finemap_res_single$cs_index != 0 & finemap_res_single$susie_pip >0.8,]
sig_gene_multi <- combined_pip_by_types[combined_pip_by_types$combined_pip > 0.8,]
