...
plot_3venn <- function(es, esra, ess) {
  ...
  venn.plot <- draw.triple.venn(
      ...
      category = c("e+s", "e+s+rs+apa", "e+e+st"),
...
heatmap_data <- rename_heatmap_columns(heatmap_data = heatmap_data, column_order = column_order)
p2 <- plot_heatmap(heatmap_data = heatmap_data,main = "PIP partition for the genes reported by e + s + apa + rs setting but not by e+s setting")
