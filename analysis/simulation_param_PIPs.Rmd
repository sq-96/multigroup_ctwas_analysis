  ...
  for(null_method in null_methods){
    for(group_prior_var_structure in group_prior_var_structures){
      for(thin in thins){
        ...
        plot_par_4(truth,est,xlabels = c("Liver", "Adipose", "Lung", "Stomach"),ylim=c(0,max(est[,2])),ylab="Prior inclusion", main=paste0("thin",thin,",",group_prior_var_structure,",",null_method))
      }
    }
  }
}
