...
for(i in names(sample_size)){
  ...
  cat("\n\n")
  cat(knitr::knit_print(DT::datatable(prop_h2g, caption = htmltools::tags$caption( style = 'font-size: 160px; caption-side: topleft; text-align = left; color:black;',i),options = list(pageLength = 7))))
  cat("\n\n")
}
```