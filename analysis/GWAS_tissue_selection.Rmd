...
for(i in names(sample_size)){
  ...
  cat(knitr::knit_print(DT::datatable(prop_h2g,caption = htmltools::tags$caption( style = 'font-size: 500px; aption-side: topleft; text-align = left; color:black;',i),options = list(pageLength = 10))))
}
```