...
f1 <- ggbarplot(plot_df, 
          ...
          ylab="Count", 
          xlab="",
          palette = colset) + grids(linetype = "dashed") + theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1)) + scale_y_break(c(100, 250),space=0.5,scales="free")
```
...
f2 <- ggbarplot(plot_df, 
          ...
          ylab="Count", 
          xlab="",
          palette = colset) + grids(linetype = "dashed") + theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust=1)) + scale_y_break(c(70, 130),space=0.5,scales="free")
```
...
```{r, fig.width= 5, fig.height= 3, echo=FALSE, message=FALSE, results='hide', warning=FALSE}
f1 <- plot_PIP_estimatedL(results_dir, runtag, simutags, "UKBBLD", main = "Molecular Trait Level")
f2 <- plot_gene_PIP_estimatedL(results_dir, runtag, simutags, "UKBBLD", main = "Gene Level")
gridExtra::grid.arrange(f1, f2, ncol = 2)
```
