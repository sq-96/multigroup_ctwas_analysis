...
```{r}
results_dir <- "/project/xinhe/shengqian/cTWAS_simulation_old/simulation_four_tissues_expression_old/"
runtag = "four_tissues"
...
for(simutag in simutags){
    regions <- readRDS(paste0(results_dir,runtag,"_simu",simutag,"_","UKBBLD",".screened_region_data.RDS"))
