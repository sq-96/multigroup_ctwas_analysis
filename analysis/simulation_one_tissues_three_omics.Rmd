...
plot_Prior(results_dir,runtag,simutags,1,"shared_all","ctwas",".minp08.mingene0.parameters.RDS",prior_true)
```
...
results_dir <- "/project/xinhe/shengqian/cTWAS_simulation/simulation_one_tissue_three_omics/"
runtag = "one_tissues_three_omics"
plot_enrichment(results_dir,runtag,simutags,1,"shared_all","ctwas",".minp08.mingene0.parameters.RDS",enrichment_true)
```
...
results_dir <- "/project/xinhe/shengqian/cTWAS_simulation/simulation_one_tissue_three_omics/"
runtag = "one_tissues_three_omics"
plot_PHE(results_dir,runtag,simutags,1,"shared_all","ctwas",".minp08.mingene0.parameters.RDS",phe_true)
```
