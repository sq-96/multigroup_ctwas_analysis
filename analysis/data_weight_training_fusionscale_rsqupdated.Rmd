...
## Comparing ENET and linear regression for the genes with more than 1 QTL 
...
for (tissue in name_mapping$Munro_name) {
  ...
  ### linear
  rsq_linear <- readRDS(paste0(folder_pred, tissue, "_rsq_fusion_lm.RDS"))
  
  ### enet
  rsq_enet <- readRDS(paste0(folder_pred, tissue, "_rsq_fusion_enetrefit_lm.RDS"))
