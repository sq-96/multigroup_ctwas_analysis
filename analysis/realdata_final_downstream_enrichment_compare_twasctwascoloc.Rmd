...
traits <- c("LDL-ukb-d-30780_irnt","IBD-ebi-a-GCST004131","T1D-GCST90014023","SBP-ukb-a-360","BMI-panukb","HB-panukb","Height-panukb")
...
for (trait in traits){
  ...
  cat("<br>")
  cat("<br>")
  cat(knitr::knit_print(DT::datatable(df_ctwas,caption = htmltools::tags$caption( style = 'caption-side: left; text-align: left; color:black;  font-size:150% ;','Enriched GO terms -- ctwas '),options = list(pageLength = 2) )))
  cat("<br>")
  cat("<br>")
  cat("<br>")
  cat("<br>")
  ...
  cat("<br>")
  cat("<br>")
  cat(knitr::knit_print(DT::datatable(df_twas,caption = htmltools::tags$caption( style = 'caption-side: left; text-align: left; color:black;  font-size:150% ;','Enriched GO terms -- twas '),options = list(pageLength = 2) )))
  cat("<br>")
  cat("<br>")
  cat("<br>")
  cat("<br>")
  ...
  cat("<br>")
  cat("<br>")
  cat(knitr::knit_print(DT::datatable(df_coloc,caption = htmltools::tags$caption( style = 'caption-side: left; text-align: left; color:black;  font-size:150% ;','Enriched GO terms -- coloc '),options = list(pageLength = 2) )))
  cat("<br>")
  cat("<br>")
  cat("<br>")
  cat("<br>")
