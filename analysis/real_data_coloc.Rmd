...
hist(as.vector(table(finemap_res[finemap_res$PP4>0.8,]$region_id)), xlab ="number of molecular traits in a locus", main = "coloc",ylim = c(0,50),xlim = c(1,7),breaks = 8)
...
hist(as.vector(table(finemap_res[finemap_res$PP4>0.8,]$region_id)), xlab ="number of molecular traits in a locus", main = "coloc",ylim = c(0,100), xlim = c(1,30), breaks = 20)
hist(as.vector(table(finemap_res[finemap_res$susie_pip>0.8,]$region_id)), xlab ="number of molecular traits in a locus", main = "multi-ctwas",add=TRUE,col='red',breaks = 2)
```
...
hist(as.vector(table(finemap_res[finemap_res$PP4>0.8,]$region_id)), xlab ="number of molecular traits in a locus", main = "coloc",ylim = c(0,20),xlim = c(1,30),breaks = 15)
hist(as.vector(table(finemap_res[finemap_res$susie_pip>0.8,]$region_id)), xlab ="number of molecular traits in a locus", main = "multi-ctwas",add=TRUE, col='red',breaks = 2)
```
