...
### Silver standard for T2D LDL BMI RBC -- summary

```{r fig.height=10, fig.width=10, message=FALSE, warning=FALSE}

traits_used_in_silver <- c("T2D-panukb","LDL-ukb-d-30780_irnt","BMI-panukb","RBC-panukb")
traits_silver <- c("T2D","LDL","BMI","RBC")
top_tissues <- c("Pituitary","Liver","Cells_Cultured_fibroblasts","Skin_Not_Sun_Exposed_Suprapubic")
names(top_tissues) <- c("T2D-panukb","LDL-ukb-d-30780_irnt","BMI-panukb","RBC-panukb")
...
### Silver standard for T2D LDL BMI RBC
