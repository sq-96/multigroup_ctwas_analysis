...
plot_PIP_ctwas <- function(results_dir, runtag,  simutags, ...){
  ...
  susieIfs <- paste0(results_dir, runtag, "_simu",simutags, "_UKBBLD.true_parameter.","ctwas_null.finemap_regions_res.RDS")
...
plot_PIP_susie <- function(results_dir, runtag,  simutags, ...){
  phenofs <- paste0(results_dir, runtag, "_simu", simutags, "-pheno.Rd")
  susieIfs <- paste0(results_dir, runtag, "_simu",simutags, "_UKBBLD.true_parameter.","susie_null.finemap_regions_res.RDS")
  f1 <- caliPIP_plot_csindex(phenofs, susieIfs, ...) 
  return(f1)
}
```
