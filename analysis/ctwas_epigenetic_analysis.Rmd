...
aa <- finemap_res_multi[finemap_res_multi$type!="SNP" & finemap_res_multi$type!="eQTL" & finemap_res_multi$susie_pip>0.8,]
dim(aa)

setDT(finemap_res_multi)
bb <- finemap_res_multi[grepl("^L[0-9]+$", cs) & type %in% c("mQTL", "caQTL")]
...
make_locusplot(finemap_res_multi,
               region_id = "1_114331223_115337972",
