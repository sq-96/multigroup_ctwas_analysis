...
print("filtering based on the number of high PIP genes")
...
colnames(comb) <- c("without_filtering","#ofgene","filtered","#ofgene")
DT::datatable(comb,options = list(pageLength = 10))



print("filtering based on PVE explained by genes")
