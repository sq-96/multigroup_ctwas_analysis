...
### Figure S11: Comparison of number of signals per region between M-cTWAS, Coloc and TWAS (other traits)
...
### Figure S12: Coloc examples at FASD1 locus
...
### Figure S13: Compare with TGFM: (HTN)
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.height=6, fig.width=8}
library(grex)
library(ggplot2)
...
### Figure S14: cTWAS helps identify causal modality and context (other traits)
...
### Figure S15: Novel gene category for other traits
...
### Figure S16: Network analysis of candidate genes suggests novel pathways (IBD)
```{r,echo=FALSE, message=FALSE, warning=FALSE, fig.width= 5, fig.height= 5}
...
### Figure S17: Locus plot of highlighted gene
#### LDLR
<figure class="half">
...
### Figure S18: Do eQTLs explain epiQTLs? Why eQTLs do not explain epiQTLs. Cell type specific mQTLs
...
### Figure S19: Do eQTLs explain epiQTLs? GTEx is limited in power. Most mQTLs and caQTLs are eQTLs in MetaBrain eQTL
