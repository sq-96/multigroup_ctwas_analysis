...
### Figure S: Partition of h2g for other traits
...
### Figure S: Existing methods may overestimate the contribution of molQTL (other traits).
https://sq-96.github.io/multigroup_ctwas_analysis/overestimate_eQTL_supplementary.html

### Figure S: Existing methods may overestimate the contribution of molQTL for other traits
https://sq-96.github.io/multigroup_ctwas_analysis/overestimate_eQTL_supplementary.html
...
### Figure S: Incorporating multiple modality and tissues improves discovery power (other traits)
...
### Figure 4b: POPS scores of individual trait
...
### Figure S: Comparison of number of signals per region between M-cTWAS, Coloc and TWAS (other traits)
...
### Figure S8: Coloc examples at FASD1 locus
...
### Figure S9: Compare with TGFM: (HTN)
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.height=6, fig.width=8}
library(grex)
library(ggplot2)
...
### Figure S: cTWAS helps identify causal modality and context (other traits)
...
### Figure S: Novel gene category for other traits
...
### Figure S10: Network analysis of candidate genes suggests novel pathways
```{r,echo=FALSE, message=FALSE, warning=FALSE, fig.width= 5, fig.height= 5}
...
### Figure S11: Do eQTLs explain epiQTLs? Why eQTLs do not explain epiQTLs. Cell type specific mQTLs
...
### Figure S12: Do eQTLs explain epiQTLs? GTEx is limited in power. Most mQTLs and caQTLs are eQTLs in MetaBrain eQTL
