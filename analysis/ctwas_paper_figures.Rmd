...
ggplot(df, aes(x = category, y = count, fill = category)) +
  ...
  scale_fill_manual(values = c("Gene" = "#7fc97f", "CRE" = "#fdc086"))+
  theme_minimal() +
  theme(legend.position = "none")
```
...
ggplot(df, aes(x = category, y = prop, fill = category)) +
  ...
  scale_fill_manual(values = c("CpGs in CREs" = "#7fc97f", "Random CpGs" = "#fdc086"))+
...
ggplot(df, aes(x = Bar, y = Value, fill = Component)) +
  ...
  scale_fill_manual(values = c("eQTL" = "#7fc97f", 
                               "mQTL" = "#fdc086", 
                               "caQTL" = "#beaed4"))+
  theme_minimal() +
...
ggplot(df2, aes(x = Bar, y = Value, fill = Component)) +
  ...
  geom_text(aes(label = round(Value, 3)),
            ...
            color = "white", size = 4) +
  scale_fill_manual(values = c("eQTL" = "#7fc97f", "epiQTL" = "#fdc086"),
