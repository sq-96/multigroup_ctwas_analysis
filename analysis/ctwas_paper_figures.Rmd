...
print(generate_piecharts_for_trait(ctwas_parameters_single, ctwas_parameters_multi, title_top = title))
```
...
### Figure 2e: MECS estimated eQTL heritability contributions
```{r echo=FALSE, message=FALSE, warning=FALSE}
