...
plot_par_2(truth,est,xlabels = c("Expression","Splicing"),ylim=c(0,0.025),ylab="Prior inclusion")
```
...
est <- rbind(cbind(1,y1),cbind(2,y2))
plot_par_2(truth,est,xlabels = c("Expression","Splicing"),ylim=c(0,0.09),ylab="PVE")
```
