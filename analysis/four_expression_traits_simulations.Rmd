...
```{r, fig.width= 24, fig.height= 4, echo=FALSE, warning=FALSE}
...
f5 <- plot_PIP_estimated_parameter_true_L(results_dir, runtag, simutags, "UKBBLD", main = "Estimated Parameter True L")
f6 <- plot_PIP_estimated_parameter_estimated_L(results_dir, runtag, simutags, "UKBBLD", main = "Estimated Parameter Estimated L")
gridExtra::grid.arrange(f1, f2, f3, f4, f5, f6, ncol = 6)
```
...
f5 <- plot_combined_PIP_estimated_parameter_true_L(results_dir, runtag, simutags, "UKBBLD", main = "Estimated Parameter True L")
f6 <- plot_combined_PIP_estimated_parameter_estimated_L(results_dir, runtag, simutags, "UKBBLD", main = "Estimated Parameter Estimated L")
gridExtra::grid.arrange(f1, f2, f3, f4, f5, f6, ncol = 6)
```
