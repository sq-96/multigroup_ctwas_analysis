...
pip_partition_across_tissue(results_dir, runtag, simutags, "GTEXLD", PIP_threshold = 0.8)
```

### PIP attribution among tissues (GTEXLD)
```{r, echo=FALSE, fig.width= 5, fig.height= 4, warning=FALSE}
pip_partition_across_tissue(results_dir, runtag, simutags, "UKBBLD", PIP_threshold = 0.8)
```
