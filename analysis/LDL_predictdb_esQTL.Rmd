...
knitr::opts_chunk$set(fig.path = "docs/figure/LDL_predictdb_esQTL.Rmd/")
```
...
```{r echo=T, eval=T}
E_S_A_mapping <- readRDS("/project2/xinhe/shared_data/multigroup_ctwas/weights/mapping_files/PredictDB_mapping.RDS")
