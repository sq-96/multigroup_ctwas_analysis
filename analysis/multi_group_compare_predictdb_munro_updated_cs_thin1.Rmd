---
title: "Comparing predictdb & Munro: predictdb eQTL + sQTL VS Munro 6 modalities -- updated functions -- thin method V1"
author: "XSun"
date: "2024-08-08"
output:
...
results_dir_predictdb <- paste0("/project/xinhe/xsun/multi_group_ctwas/7.multi_omics_predicdb/results_predictdb_main_thin1/",trait,"/")
...
finemap_res_predictdb <- ctwas_res_predictdb$finemap_res
finemap_res_predictdb$molecular_id <- get_molecular_ids(finemap_res_predictdb)

finemap_res_predictdb <- anno_finemap_res(finemap_res_predictdb,
                              snp_map = snp_map_predictdb,
                              mapping_table = E_S_A_mapping_predictdb,
                              add_gene_annot = TRUE,
                              map_by = "molecular_id",
                              drop_unmapped = TRUE,
                              add_position = TRUE,
...
combined_pip_by_type_predictdb <- combine_gene_pips(finemap_res = finemap_res_predictdb,
                                  group_by = "gene_name",
                                  by = "type", 
                                  method = "combine_cs",
                                  filter_cs = T)
...
results_dir_munro <- paste0("/project/xinhe/xsun/multi_group_ctwas/7.multi_omics_predicdb/results_munro_main_thin1/",trait,"/")
...
finemap_res_munro <- ctwas_res_munro$finemap_res
finemap_res_munro$molecular_id <- get_molecular_ids(finemap_res_munro)

finemap_res_munro <- anno_finemap_res(finemap_res_munro,
                              snp_map = snp_map_munro,
                              mapping_table = E_S_A_mapping_munro,
                              add_gene_annot = TRUE,
                              map_by = "molecular_id",
                              drop_unmapped = TRUE,
                              add_position = TRUE,
...
combined_pip_by_type_munro <- combine_gene_pips(finemap_res = finemap_res_munro,
                                  group_by = "gene_name",
                                  by = "type", 
                                  method = "combine_cs",
                                  filter_cs = T)
...
finemap_res_munro <- finemap_res_munro[complete.cases(finemap_res_munro$pos),]
...
finemap_region_res_predictdb$molecular_id <- get_molecular_ids(finemap_region_res_predictdb)

finemap_region_res_predictdb <- anno_finemap_res(finemap_region_res_predictdb,
                              snp_map = snp_map_predictdb,
                              mapping_table = E_S_A_mapping_predictdb,
                              add_gene_annot = TRUE,
                              map_by = "molecular_id",
...
load("/project/xinhe/xsun/multi_group_ctwas/7.multi_omics_predicdb/results_postprocess/RTEL1_mergedregion_plot_thin1.rdata")
...
```{r echo=FALSE}
z_snp <- readRDS("/project/xinhe/xsun/multi_group_ctwas/7.multi_omics_predicdb/results_munro_main_thin1/IBD-ebi-a-GCST004131/IBD-ebi-a-GCST004131.preprocessed.z_snp.RDS")
