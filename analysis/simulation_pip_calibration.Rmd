...
plot_PIP_shared_all_ctwas <- function(results_dir, runtag,  simutags, ...){
  ...
  susieIfs <- paste0(results_dir, runtag, "_simu",simutags, ".thin1.shared_all.ctwas.estimated_parameter.finemap_regions_res.RDS")
...
plot_PIP_shared_type_ctwas <- function(results_dir, runtag,  simutags, ...){
  phenofs <- paste0(results_dir, runtag, "_simu", simutags, "-pheno.Rd")
  susieIfs <- paste0(results_dir, runtag, "_simu",simutags, ".thin1.shared_type.ctwas.estimated_parameter.finemap_regions_res.RDS")
  f1 <- caliPIP_plot(phenofs, susieIfs, ...) 
  return(f1)
}
...
plot_PIP_shared_all_susie <- function(results_dir, runtag,  simutags, ...){
  phenofs <- paste0(results_dir, runtag, "_simu", simutags, "-pheno.Rd")
  susieIfs <- paste0(results_dir, runtag, "_simu",simutags, ".thin1.shared_all.susie.estimated_parameter.finemap_regions_res.RDS")
  f1 <- caliPIP_plot(phenofs, susieIfs, ...) 
  return(f1)
}
...
plot_PIP_shared_type_susie <- function(results_dir, runtag,  simutags, ...){
  phenofs <- paste0(results_dir, runtag, "_simu", simutags, "-pheno.Rd")
  susieIfs <- paste0(results_dir, runtag, "_simu",simutags, ".thin1.shared_type.susie.estimated_parameter.finemap_regions_res.RDS")
  f1 <- caliPIP_plot(phenofs, susieIfs, ...) 
  return(f1)
}

plot_power <- function(results_dir,runtag,simutags){
  pipfs_all_ctwas <- paste0(results_dir, runtag, "_simu",simutags, ".thin1.shared_all.ctwas.estimated_parameter.finemap_regions_res.RDS")
  pipfs_type_ctwas <- paste0(results_dir, runtag, "_simu",simutags, ".thin1.shared_type.ctwas.estimated_parameter.finemap_regions_res.RDS")
  pipfs_all_susie <- paste0(results_dir, runtag, "_simu",simutags, ".thin1.shared_all.susie.estimated_parameter.finemap_regions_res.RDS")
  pipfs_type_susie <- paste0(results_dir, runtag, "_simu",simutags, ".thin1.shared_type.susie.estimated_parameter.finemap_regions_res.RDS")
  phenofs <- paste0(results_dir, runtag, "_simu", simutags, "-pheno.Rd")
