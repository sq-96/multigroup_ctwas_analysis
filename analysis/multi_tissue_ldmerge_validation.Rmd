...
print("please not the beta column in the table below is not correct, the beta is calculated from colSums(fit$alpha * fit$mu)\n but for linear fit, it missed a scale factor. Others are correct")
