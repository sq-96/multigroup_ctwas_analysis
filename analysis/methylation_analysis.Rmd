...
make_locusplot(finemap_res_multi,
               ...
               axis.title.size = 18,
               legend.text.size = 18,
               panel.heights = c(4, 4, 0.8, 2))
dev.off()

pdf(file = "/project/xinhe/shengqian/ETS1.pdf",width = 12,height = 10)
#finemap_res_multi[finemap_res_multi$gene_name=="TNFSF15",]
make_locusplot(finemap_res_multi,
               region_id = "11_128318642_130472680",
               #locus_range = c(128318642, 128800000),
               ens_db = ens_db,
               weights = weights_multi,
               highlight_pip = 0.8,
               filter_protein_coding_genes = TRUE,
...
make_locusplot(finemap_res_multi,
               ...
               locus_range = c(32214887, 32614887),
               ens_db = ens_db,
               weights = weights_multi,
               highlight_pip = 0.8,
               filter_protein_coding_genes = TRUE,
...
pdf(file = "/project/xinhe/shengqian/ADCY3.pdf",width = 12,height = 10)
#finemap_res_multi[finemap_res_multi$gene_name=="TNFSF15",]
make_locusplot(finemap_res_multi,
               region_id = "2_24464049_26672117",
               locus_range = c(24464049, 25272117),
               ens_db = ens_db,
               weights = weights_multi,
               highlight_pip = 0.8,
               filter_protein_coding_genes = TRUE,
...
pdf(file = "/project/xinhe/shengqian/RGS14.pdf",width = 12,height = 10)
#finemap_res_multi[finemap_res_multi$gene_name=="TNFSF15",]
make_locusplot(finemap_res_multi,
...
finemap_res_multi[!is.na(finemap_res_multi$gene_name) & finemap_res_multi$gene_name == "SEC16A", ]
pdf(file = "/project/xinhe/shengqian/SEC16A.pdf",width = 12,height = 10)
#finemap_res_multi[finemap_res_multi$gene_name=="TNFSF15",]
make_locusplot(finemap_res_multi,
