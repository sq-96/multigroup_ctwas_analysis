...
make_locusplot(finemap_res_8weights,
               ...
               focal_gene = "TNFRSF6B",
               R_snp_gene = cor_res$R_snp_gene,
               R_gene = cor_res$R_gene,legend.position = "top",
               point.shapes = c(16, 15, 18, 17,14,11,6,8,9))
...
finemap_res_sqtlpred <- anno_finemap_res_old(finemap_res_sqtlpred, snp_map_sqtlpred,E_S_A_mapping_two,
                                use_gene_pos = "mid")

combined_pip_by_type_sqtlpred <- combine_gene_pips_old(finemap_res_sqtlpred, 
                                             by = "type",
                                             filter_protein_coding_genes = TRUE,    
                                             filter_cs = TRUE,digits = 4)
...
cor_dir <- paste0("/project/xinhe/xsun/multi_group_ctwas/8.deciding_weights/sqtlpred/",trait,"/cor_matrix")
cor_res <- get_region_cor(region_id = "20_63558827_64333810", cor_dir = cor_dir)
